#!/usr/bin/env python3
"""
Pipeline Diagnostic Tool — fast, visual validation of detection + tracking + classification + analytics.

Usage:
    python diagnostics.py "/path/to/video.mov"
    python diagnostics.py "/path/to/video.mov" --start 300 --frames 30 --sample-rate 5
    python diagnostics.py "/path/to/video.mov" --my-team black --frames 60
